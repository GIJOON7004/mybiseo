...
export function generateAdditionalItems(ctx: AnalysisContext): SeoCheckItem[] {
  ...
  // 항목 수 고정: PageSpeed 실패 시에도 항상 5개 항목 생성 ("측정 불가" 상태)
  {
    ...
    items.push({
      ...
      status: hasLcp ? (lcpGood ? "pass" : lcpOk ? "warning" : "fail") : "fail",
    ...
    items.push({
      ...
      status: hasFcp ? (fcpGood ? "pass" : fcpOk ? "warning" : "fail") : "fail",
    ...
    items.push({
      ...
      status: hasCls ? (clsGood ? "pass" : clsOk ? "warning" : "fail") : "fail",
    ...
    items.push({
      ...
      status: hasTbt ? (tbtGood ? "pass" : tbtOk ? "warning" : "fail") : "fail",
    ...
    items.push({
      ...
      status: hasPerf ? (perfScore >= 90 ? "pass" : perfScore >= 50 ? "warning" : "fail") : "fail",
