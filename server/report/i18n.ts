...
const i18n: Record<Lang, Record<string, string>> = {
  ...
  en: {
    ...
    disclaimer: `This report was generated by the AI Visibility Diagnostic System at ${APP_DOMAIN}. Since the internal algorithms of AI platforms (ChatGPT, Perplexity, Gemini, Claude, Cue:) and portals are proprietary, the diagnostic results serve as reference material for strategy development. Actual exposure results may vary depending on AI model updates, user location, and query context.`,
    statusPass: "Pass",
  ...
  th: {
    ...
    disclaimer: `รายงานนี้สร้างโดยระบบวินิจฉัย AI Visibility ของ ${APP_DOMAIN} ผลการวินิจฉัยเป็นข้อมูลอ้างอิงสำหรับการวางกลยุทธ์`,
    statusPass: "ผ่าน",
    statusWarning: "เตือน",
    statusFail: "ไม่ผ่าน",
    naverLabel: "Naver",
