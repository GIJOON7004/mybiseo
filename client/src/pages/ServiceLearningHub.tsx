  ...
  return (
    <ServicePageLayout
      ...
      theme={{
        ...
        gradient: "linear-gradient(135deg, oklch(0.65 0.15 290), oklch(0.55 0.18 280))",
      }}
      hero={{
        badge: "학습 허브",
        badgeIcon: BookOpen,
        ...
        subtitle: "AI 학습 허브",
        description: "AI에게 우리 병원 정보를 정확하게 학습시킵니다. 구조화된 데이터로 AI가 정확한 답변을 하도록 만드는 유일한 방법입니다.",
        primaryCta: { label: "도입 상담 신청", href: "https://pf.kakao.com/_KYjGn" },
        secondaryCta: { label: "무료 AI 진단 받기", navigate: "/ai-check" },
      }}
      problems={{
        title: "AI가 우리 병원을 잘못 알고 있습니다",
        subtitle: "AI에게 정확한 정보를 제공하지 않으면, 잘못된 답변이 환자에게 전달됩니다.",
        items: [
          {
            icon: AlertTriangle,
            title: "부정확한 AI 답변",
      ...
      solution={{
        title: "마이비서가 AI를 교육합니다",
        subtitle: "병원의 모든 정보를 구조화하고, AI가 정확하게 학습하도록 만듭니다. 결과적으로 AI가 우리 병원을 정확하게 추천합니다.",
        stats: [
          { icon: Database, value: "100%", label: "병원 정보 구조화율" },
          { icon: Code2, value: "9종", label: "Schema 마크업 적용" },
      ...
      process={{
        title: "작동 방식",
        subtitle: "4단계 프로세스로 AI가 병원을 정확하게 이해하도록 만듭니다.",
        steps: [
          { step: "01", title: "병원 데이터 구조화", desc: "시술·의료진·장비·후기 등 병원의 모든 정보를 AI가 학습할 수 있는 형태로 구조화합니다.", icon: Database },
          { step: "02", title: "AI 크롤러 최적화", desc: "llms.txt, Schema 마크업, 구조화 데이터를 배포하여 AI 크롤러가 정보를 정확히 수집하도록 합니다.", icon: Code2 },
          { step: "03", title: "AI 답변 모니터링", desc: "주요 AI 플랫폼에서 병원 관련 질문에 대한 답변 정확도를 실시간 추적합니다.", icon: BarChart3 },
          { step: "04", title: "지속적 교정·업데이트", desc: "부정확한 AI 답변을 감지하면 데이터를 교정하고, 새로운 정보를 지속적으로 학습시킵니다.", icon: RefreshCw },
        ],
      }}
      caseStudy={{
        tag: "성형외과 · 서울 압구정",
        title: "C 성형외과, AI 답변 정확도 32% → 96%로 개선",
        desc: "ChatGPT에 C 성형외과를 물어보면 폐업한 진료과를 추천하거나 잘못된 원장 정보를 답변하던 상황이었습니다. 마이비서 AI Learning Hub 도입 후 2개월 만에 AI 답변 정확도가 96%까지 개선되었고, AI 추천을 통한 신환 문의가 시작되었습니다.",
        stats: [
          { value: "96%", label: "AI 답변 정확도" },
          { value: "2개월", label: "소요 기간" },
          { value: "+23건", label: "월 AI 추천 신환" },
        ],
        before: "AI 답변 정확도 32%",
        after: "AI 답변 정확도 96%",
      }}
      ...
      cta={{
        title: "AI가 우리 병원을 정확하게 알도록 만드세요",
        description: "무료 진단으로 현재 AI가 우리 병원을 어떻게 알고 있는지 확인하고, 정확한 학습 전략을 받아보세요.",
        primaryCta: { label: "도입 상담 신청", href: "https://pf.kakao.com/_KYjGn" },
        secondaryCta: { label: "무료 AI 진단 받기", navigate: "/ai-check" },
      }}
    />
