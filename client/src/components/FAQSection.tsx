...
const faqs = [
  // ── 검색 최적화 관련 (상단) ──
  {
    ...
    a: "100% 보장은 어렵지만, 환자가 검색할 때 병원이 잘 보이도록 기술적으로 세팅하는 작업입니다. 쉽게 말해, 네이버·구글이 우리 병원 정보를 더 잘 읽을 수 있게 정리해주는 것입니다. 실제 도입 병원 중 80% 이상이 3개월 내 포털 및 AI 검색에서 상위 노출을 달성했습니다.",
  },
  {
  ...
  // ── 도입/효과 관련 ──
  {
    ...
    a: "오히려 반대입니다. 밤 10시에 전화해서 안 받히는 것보다, AI가 바로 답해주는 게 환자 만족도가 훨씬 높습니다. 실제 도입 병원에서 환자 불만 사례는 0건이며, '편하다'는 피드백이 대부분입니다.",
  },
  {
